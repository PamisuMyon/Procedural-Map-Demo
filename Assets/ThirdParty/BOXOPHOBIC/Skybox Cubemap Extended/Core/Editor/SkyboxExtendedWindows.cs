...
{
    [MenuItem("Window/BOXOPHOBIC/Skybox Cubemap Extended/Publisher Page", false, 2000)]
    public static void MoreAssets()
    {
        Application.OpenURL("https://assetstore.unity.com/publishers/20529");
    }

    [MenuItem("Window/BOXOPHOBIC/Skybox Cubemap Extended/Discord Server", false, 2001)]
    public static void Discord()
    {
        Application.OpenURL("https://discord.com/invite/znxuXET");
    }

    [MenuItem("Window/BOXOPHOBIC/Skybox Cubemap Extended/Documentation", false, 2002)]
    ...
    [MenuItem("Window/BOXOPHOBIC/Skybox Cubemap Extended/Changelog", false, 2003)]
    ...
    [MenuItem("Window/BOXOPHOBIC/Skybox Cubemap Extended/Write A Review", false, 3000)]
